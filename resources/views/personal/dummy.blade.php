                ...
                <form action="{{ url('/personalstore') }} " method="POST" enctype="multipart/form-data">
                    <div class="form_container">
                        <div class="input_wrap">
                            ...
                            <input type="text" name="education[0][Company_name]" placeholder="Enter your institution"
                                required>
                        </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" name="education[0][Achievment]" placeholder="Enter your achievement"
                                required>
                        </div>
                    </div>
                </form>
                ...
                <form action="{{ url('/personalstore') }} " method="POST" enctype="multipart/form-data">
                    <div class="form_container">
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" name="experience[0][Job_title]" placeholder="Enter your job title"
                                required>
                        </div>
